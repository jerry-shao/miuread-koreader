...
ok('VERSION = "5.8.0-beta.21"' in cfg,'version is 5.8.0-beta.21')
...
ok('version = "5.8.0-beta.21"' in meta,'plugin metadata version is beta.21')
...
if texlua.exists():
    for tool in ['test_extension_catalog.lua','test_extension_download.lua','test_extension_install.lua','test_store_repair.lua','test_store_shared.lua','test_digest_stream.lua','test_readtime_recovery.lua','test_shelf_group_recovery.lua','test_online_comment_likes.lua']:
